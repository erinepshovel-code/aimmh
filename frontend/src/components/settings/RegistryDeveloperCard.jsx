  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950/60">
      <div className="border-b border-zinc-800 px-4 py-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={() => onRemoveDeveloper(developer.developer_id)} className="rounded-xl border border-zinc-800 p-2 text-zinc-500 transition hover:border-red-500/30 hover:text-red-300">
              <Trash2 size={13} />
            </button>
          </div>
        </div>
      ...
      <div className="space-y-2 p-3">
          ...
          return (
            <div key={model.model_id} className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-3">
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button onClick={() => onInstantiateModel(developer, model)} className="rounded-xl border border-zinc-800 px-3 py-2 text-xs text-zinc-300 transition hover:border-zinc-700 hover:text-white">
                  ...
                  <button onClick={() => onRemoveModel(developer.developer_id, model.model_id)} className="rounded-xl border border-zinc-800 p-2 text-zinc-500 transition hover:border-red-500/30 hover:text-red-300">
                    <Trash2 size={13} />
                  </button>
                </div>
              </div>
        ...
        {addingModel === developer.developer_id ? (
          <div className="mt-3 flex flex-wrap items-center gap-2 rounded-2xl border border-zinc-800 bg-zinc-900/60 p-3">
            ...
            />
            <button onClick={() => onAddModel(developer.developer_id)} className="rounded-xl bg-emerald-600 px-3 py-2 text-xs font-medium text-white hover:bg-emerald-500">Add model</button>
            <button onClick={() => setAddingModel('')} className="text-xs text-zinc-500 hover:text-zinc-300">Cancel</button>
          </div>
        ) : (
          <button onClick={() => setAddingModel(developer.developer_id)} className="mt-2 inline-flex items-center gap-2 px-1 text-xs text-zinc-500 hover:text-zinc-300">
